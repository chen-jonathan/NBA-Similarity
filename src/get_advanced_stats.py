...
"""
File to scrape 2019-2020 Advanced stats data, amend problems in dataset and write 
the refined data to a csv file.
"""
# URL page we will scraping
year = 2020
url = "https://www.basketball-reference.com/leagues/NBA_2020_advanced.html".format(
    year)
html = urlopen(url)
...
data.to_csv('advanced_stats.csv', index = False)
